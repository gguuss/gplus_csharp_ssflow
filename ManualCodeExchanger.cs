...
// Has references to client credentials
using GPlusWrapper;
...
namespace GPlus_ServerSideFlow
{
    ...
    public class ManualCodeExchanger
    {
        ...
        static public string FormPostData(string code)
        {
            ...
            builder.Append(PlusWrapper.ClientCredentials.ClientID);
            builder.Append("&client_secret=");
            builder.Append(PlusWrapper.ClientCredentials.ClientSecret);            
            builder.Append("&redirect_uri=");
            builder.Append(PlusWrapper.ClientCredentials.RedirectUri);
